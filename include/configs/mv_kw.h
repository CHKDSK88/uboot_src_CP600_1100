...
/************/
#ifdef MV_TINY_IMAGE
#define CONFIG_IDENT_STRING	" Check Point version: TINY -"
#else
#define CONFIG_IDENT_STRING	" Check Point version:"
#endif /* MV_TINY_IMAGE */
/* version number passing when loading Kernel */
#define VER_NUM 0x03041b00           /* 3.4.27 */
...
#define	CFG_PROMPT	"Check Point>> "	/* Monitor Command Prompt	*/
...
#if defined(MV_88F6183) || defined(MV_88F6183L) || defined(MV88F6282) || \
...
#define CP_PRIMARY_OFFSET		0x00100000
#ifdef SEATTLE
#define CP_SECONDARY_OFFSET		0x07A00000
#define CP_DEFAULT_IMAGE_OFFSET	0x0F300000
#define	CP_LOGS_OFFSET			0x16C00000
#define	CP_PRESET_CFG_OFFSET	0x18400000
#define	CP_ADSL_OFFSET		0x18500000
#define	CP_STORAGE_OFFSET	0x18600000
#define	CP_ADSL_SIZE		0x00100000
#define	CP_PRESET_CFG_SIZE	0x00100000
#define CP_STORAGE_SIZE		0x07A00000
#define	CP_IMAGE_SIZE		0x07900000
#define	CP_LOG_SIZE		0x01800000
#else
#define CP_SECONDARY_OFFSET		0x05f00000
#define CP_DEFAULT_IMAGE_OFFSET	0x0bd00000
#define	CP_IMAGES_BACK_OFFSET	0x11b00000
#define	CP_CONFIG_BACK_OFFSET	0x17900000
#define	CP_LOGS_OFFSET			0x18900000
#define	CP_LOG_SIZE			0x01700000
#define	CP_STORAGE_OFFSET		0x1a000000
#define CP_STORAGE_SIZE			0x06000000
#define	CP_IMAGE_SIZE			0x05e00000
#endif
#define	CP_KERNEL_SIZE			0x00800000
#define CP_FLASH_END			0x20000000
#define CP_FLASH_ERASE_SIZE		0x1ff00000
#define CP_BOOT_ADDR			0x02000200

#define CP_IMG_HEADER_LEN		0x00000200

/* Offsets within image header - used for CRC verification */
#define CP_CRC_OFFSET		(5*sizeof(MV_U32))
#define CP_IMG_LEN_OFFSET	(4*sizeof(MV_U32))
#define CP_IMG_NAME_OFFSET	(7*sizeof(MV_U32))



/* Pre-processor verification that dependent macros are valid */
#if (CP_FLASH_ERASE_SIZE != (CP_FLASH_END - CP_PRIMARY_OFFSET))
#error CP_FLASH_ERASE_SIZE != CP_FLASH_END - CP_PRIMARY_OFFSET
#endif

#if (CP_BOOT_ADDR !=(CFG_LOAD_ADDR + CP_IMG_HEADER_LEN))
#error CP_BOOT_ADDR != (CFG_LOAD_ADDR + CP_IMG_HEADER_LEN)
#endif

/***************************************************************/

#define CFG_CP_DEF_ENV 1

/* Reserve one page for MAC addresses, at the end of the uboot environment partition */
#define CP_BOARD_SETTINGS_NAND_ADDR	0xe0000
#define CP_NAND_OFFSET_CRC			0x00
#define CP_NAND_OFFSET_START		0x10 /* Where the settings actually start */
#define CP_NAND_OFFSET_HW_MAC		0x10
#define CP_NAND_OFFSET_LAN1_MAC		0x20
#define CP_NAND_OFFSET_LAN2_MAC		0x30
#define CP_NAND_OFFSET_LAN3_MAC		0x40
#define CP_NAND_OFFSET_LAN4_MAC		0x50
#define CP_NAND_OFFSET_LAN5_MAC		0x60
#define CP_NAND_OFFSET_LAN6_MAC		0x70
#define CP_NAND_OFFSET_LAN7_MAC		0x80
#define CP_NAND_OFFSET_LAN8_MAC		0x90
#define CP_NAND_OFFSET_DMZ_MAC		0xa0
#define CP_NAND_OFFSET_UNIT_MODEL	0xb0
#define CP_NAND_OFFSET_UNIT_VER		0xc0
#define CP_NAND_OFFSET_UNIT_NAME	0xd0 /* 64 bytes - 0x40 */
#define CP_NAND_OFFSET_WIRELESS_REGION	0x110
#define CP_NAND_OFFSET_DSL_MAC		0x120
#define CP_NAND_OFFSET_DSL_ANNEX	0x130
#define CP_NAND_OFFSET_LICENSE_TYPE	0x140
#define CP_NAND_OFFSET_HW_CAPABILITIES_TYPE	0x150
#define CP_NAND_OFFSET_MGMT_OPQ_TYPE	0x170
#define CP_NAND_OFFSET_MGMT_SIGNATURE 0x1f0
#define CP_NAND_OFFSET_MGMT_SIGNATURE_VER 0x3f0

#define CP_NAND_OFFSET_MAGIC2		0x3f0
#define CP_BOARD_SETTINGS_NAND_SIZE	0x20000	/* 128K */

#define	CP_SETTING_LEN				0x10
#define CP_UNIT_NAME_LEN			0x40 /* 64 bytes - 0x40 */

#define CP_L50_STR					"L50"
#define CP_L50_LANS_NUM				8
#define CP_L30_STR					"L30"
#define CP_L30_LANS_NUM				6
#define CP_MODEL_DEF_STR			CP_L50_STR
#define CP_DEF_LANS_NUM				CP_L50_LANS_NUM
#define CP_DEF_UNIT_NAME			"UTM1"
#define CP_DEF_UNIT_VER				1
#define CP_WORLD_REGION 			1
#define CP_DEF_WIRELESS_REGION 		CP_WORLD_REGION
#define ANNEX_A    "annexA"
#define ANNEX_B    "annexB"
#define ANNEX_C    "annexC"
#define ANNEX_STR_LEN    6

#define CP_NET_RETRY				3

/* Delay time between network failure and proceeding to local FD */
#define CP_DELAY_BEFORE_FD			1
#define CP_NET_FD_DELAY				10

#define CP_BUBT_RESETS_ENV			1

#define LED_CPU_BASE_NUM	1
#define LED_CPU_HIGH_NUM	64
#define UNSUPPORTED_LED 0
#define	GPIO_EXTENDER1  0x100
#define	GPIO_EXTENDER2  0x200

#ifdef SEATTLE
#define USB2_LED_GREEN  (2 | GPIO_EXTENDER2)
#define USB2_LED_RED    (5 | GPIO_EXTENDER2)
#define USB1_LED_GREEN  (0 | GPIO_EXTENDER2)
#define USB1_LED_RED    (4 | GPIO_EXTENDER2)
#define POWER_LED_GREEN 49
#define POWER_LED_RED   7
#define ALERT_LED_GREEN 38
#define ALERT_LED_RED   (2|GPIO_EXTENDER1)
#define ADSL_ACT UNSUPPORTED_LED
#define ADSL_LINK UNSUPPORTED_LED
#define SD_GREEN UNSUPPORTED_LED
#define WIFI_GREEN (7|GPIO_EXTENDER2)
#else
#define USB2_LED_GREEN  37
#define USB2_LED_RED    41
#define USB1_LED_GREEN  38
#define USB1_LED_RED    40
#define POWER_LED_GREEN 49
#define POWER_LED_RED   46
#define ALERT_LED_GREEN 44
#define ALERT_LED_RED   48
#define ADSL_ACT UNSUPPORTED_LED
#define ADSL_LINK UNSUPPORTED_LED
#define SD_GREEN UNSUPPORTED_LED
#define WIFI_GREEN UNSUPPORTED_LED
#endif
...
#define LED_CMD_STATIC	3


#define USB_PORTNR_USB1		 3
#define USB_PORTNR_USB2		 1
#define USB_PORTNR_UNKNOWN	-1


#define CP_NO_CRC_CHECK_VAR "no_crc_verify"

/* For cp_reset_from_usb() - load uboot or firmware */
#define CP_GET_TYPE_UNKNOWN		0
#define CP_GET_TYPE_FIRMWARE	1 
#define CP_GET_TYPE_UBOOT		2
#define CP_GET_TYPE_BOTH		3
#define CP_GET_TYPE_HW_TEST		4
#define CP_GET_TYPE_DSL			5


#define CP_BUBT_FLAG_FILE_IN_MEMORY		1

#define CP_IMAGE_PREFIX "fw1"
#define RAPID_DEP_CP_IMAGE_PREFIX "fw1_dep"

#define CP_IMAGE_SUFFIX ".img"
#define CP_UBOOT_PREFIX "u-boot"
#define CP_UBOOT_SUFFIX ".bin"
#define CP_HW_TEST_PREFIX "seattle"
#define CP_HW_TEST_SUFFIX "hwtest.bin"
#define CP_DSL_IMAGE_PREFIX "dsl"

#define CP_BOOT_MODE_QUIET				1
#define CP_BOOT_MODE_QUIET_STR			"quiet"	/* Normal */
#define CP_BOOT_MODE_DEBUG				2
#define CP_BOOT_MODE_DEBUG_STR			""		/* Debug */
#define CP_BOOT_MODE_MAINTENANCE		3
#define CP_BOOT_MODE_MAINTENANCE_STR	"maintenance"

/* Block access to uboot CLI with access code */
#define CP_REQUIRE_ACCESS_CODE
#define UBOOT_ACCESS_CODE_MAX_LEN	16
#define UBOOT_ACCESS_CODE_CRC		0xffffffff
#define	UBOOT_ACCESS_CODE_MAX_FAILURE 3
#define	UBOOT_ACCESS_CODE_REBOOT	15
#define UBOOT_ACCESS_CODE_DELAY		5

#define CP_NET_INSTALL_AUTO	1
#define CP_NET_INSTALL_MAN	2
...
#define CP_IP_STR_LEN 16
#define CP_MAX_FILENAME_LEN 128

/* Useful strings */
#define CP_IMAGE_INSTALL_FROM		"Install/Update Image from"
#define CP_IMAGE_UBOOT_INSTALL_FROM	"Install/Update Image/Boot-Loader from"
#define CP_UBOOT_INSTALL_FROM		"Install/Update Boot-Loader from"
#define CP_ENTER_SELECTION_STR		"\n\tPlease enter your selection : "
